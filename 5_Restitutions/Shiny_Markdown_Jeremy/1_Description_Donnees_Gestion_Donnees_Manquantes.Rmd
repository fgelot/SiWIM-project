...
**Idée générale** : attribuer aux données aberrantes (dont nous sommes surs qu'elles soient fausses) un valeur "NA" puis reconstituer leur valeur grace aux techniques d'imputation du package `"missMDA"`.
...
## Comparaison graphique post-imputation
