...
# Analyse bidimensionnelle (étude des liaisons)


### Etude des liaisons entre variables qualitatives (V de Cramer)
...
### Etude des liaisons entre variables quantitatives (corrélation de Pearson)
...
De nombreuses relations linéaires entre les grandeurs physiques (masse, longueur, vitesse,...)
...
## Analyse Factorielle des Donnees Mixtes (AFDM)
