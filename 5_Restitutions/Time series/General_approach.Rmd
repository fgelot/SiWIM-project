...
* Régression pénalisée (ridge/lasso/elasticnet)
    + $$ \lambda : 1,10,50,100,200,500,1000 $$
* Random forest
    + Nombre de variabes choisies aléatoirement à chaque split (mtry) : $$ 1, \sqrt(p)$$
    + Nombre d'arbres : 500
* Gradient boosting
    + Nombre d'interactions (n.trees) : 100, 500, 1000, 1500
    + nombre de noeuds terminaux des arbres plus 1 (interaction.depth) : 1, 5, 9
    + paramètre de régularisation ($\lambda$) : 0.1
    + Nombre minimum d'individus dans chaque feuille : 20
