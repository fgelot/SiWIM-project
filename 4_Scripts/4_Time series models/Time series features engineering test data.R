...
file_name <- paste("SiWIM_data_", start_date, "_to_", end_date, "_after_input", ".csv", sep= "")

siwim_data <- fread(paste("2_Data/2_Retraitees/",file_name, sep = ""))
...
write.csv(siwim_data_hours, file = "2_Data/2_Retraitees/SiWIM_test_data_hours_original.csv")

write.csv(siwim_data_dt_full, file = "2_Data/2_Retraitees/SiWIM_test_data_hours_full.csv")
