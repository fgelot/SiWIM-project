...
# Id?e g?n?rale : attribuer aux données aberrantes (dont nous sommes surs qu'elles soient fausses) un valeur "NA"
...
# on consid?re comme valeur anormale une distance totale entre les axes supérieure à 20 m(ici 5102 valeurs dans ce cas)
siwim_data[total_axle_dist > 20, total_axle_dist := NA]

# on consid?re comme valeur anormale les températures négatives < à -10°C (dans le jeu de données seule -273 est présente comme valeur négative, 2014 valeurs dans ce cas)
