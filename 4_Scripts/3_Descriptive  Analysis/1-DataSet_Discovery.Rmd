...
Plusieurs valeurs semblent aberrantes (des camions de plus cent tonnes).
...
```{r}
# On considere comme valeur anormale la masse d'un camion > à 70 T 
siwim_data[MGV > 70, MGV := NA]
```
...
Résumé des donnnées sans ces valeurs aberrantes :
